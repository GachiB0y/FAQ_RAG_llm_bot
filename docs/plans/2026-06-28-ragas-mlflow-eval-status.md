...
**Дата создания:** 2026-06-28 · **Обновлён:** 2026-07-06
**Цель:** Изучить Ragas + MLflow на реальном RAG-примере этого проекта, понять как работать и что это даёт.

---

> 📊 **Общий статус проекта и все открытые задачи** — в корневом
> [PROJECT_STATUS.md](../../PROJECT_STATUS.md). Этот файл — только про
> Ragas/MLflow-эксперимент (Шаги 1-4 ниже).
