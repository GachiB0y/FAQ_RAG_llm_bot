...
> **Текущий шаг:** ещё не начали. Следующее действие — **Шаг A (uv + lockfile)**.
> Обнови этот блок в конце каждой сессии — одна строка «что сделано, что дальше».

**Лог сессий:**
- 2026-07-06: создан план, ничего из шагов ещё не реализовано.
...
- Prefect/Dagster — пока Makefile достаточно (боль #1 закрывается частично)
